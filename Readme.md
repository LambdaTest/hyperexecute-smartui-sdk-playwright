...
# How to run Playwright tests through SmartUI SDK on HyperExecute
...
Download or Clone the code sample for the Playwright from the LambdaTest GitHub repository to run the tests on the HyperExecute.
