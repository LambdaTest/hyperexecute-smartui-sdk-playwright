# Run Playwright Tests with SmartUI SDK on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Playwright tests with SmartUI visual regression testing using HyperExecute. This sample shows how to configure Playwright + SmartUI SDK + HyperExecute to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-smartui-sdk-playwright && cd hyperexecute-smartui-sdk-playwright
npm install
```
